package com.git.push.config.timezone;

import static java.lang.String.format;
import static org.assertj.core.api.Assertions.assertThat;

import com.git.push.IntegrationTest;
import com.git.push.repository.timezone.DateTimeWrapper;
import com.git.push.repository.timezone.DateTimeWrapperRepository;
import java.time.*;
...
class HibernateTimeZoneIT {
    ...
    private String generateSqlRequest(String fieldName, long id) {
        return format("SELECT %s FROM apb_date_time_wrapper where id=%d", fieldName, id);
    }
